...
#ifndef UNITY_STANDARD_METAPLUS_INCLUDED
#define UNITY_STANDARD_METAPLUS_INCLUDED
...
#include "UnityStandardCorePlus.cginc"
...
float4 frag_meta (v2f_meta i) : SV_Target
{
    ...
    FragmentCommonData data = UNITY_SETUP_BRDF_INPUT(i.uv, float3(0,0,0));
